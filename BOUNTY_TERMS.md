...
The Bounty will be applicable for Accepted Contributions in [tt-forge](https://github.com/tenstorrent/tt-forge). An **"Accepted Contribution"** refers to merged pull requests that address an open GitHub issue which is tagged with both (1) “bounty” and (2) one of the categories listed in Exhibit A.
