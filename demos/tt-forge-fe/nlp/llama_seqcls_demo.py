...
# Select the LLaMA 3 SequenceClassification variant
LLAMA_VARIANT = SequenceClassificationVariant.LLAMA_3_2_1B

# Load model and tokenizer
loader = SequenceClassificationLoader(variant=LLAMA_VARIANT)
