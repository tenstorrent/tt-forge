...
def test_vit_base(training, batch_size, input_size, channel_size, loop_count, variant, task, data_format, model_name, measure_cpu):
    """
    ...
    # compiler_config.mlir_config = MLIRConfig().set_enable_consteval(True).set_enable_optimizer(OPTIMIZER_ENABLED)
    if data_format == "bfloat16":
        # Convert model to bfloat16
