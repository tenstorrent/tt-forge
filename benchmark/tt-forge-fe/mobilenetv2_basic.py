...
def test_mobilenetv2_basic(training, batch_size, input_size, channel_size, loop_count, task, data_format, model_name, measure_cpu):
    """
    ...
    full_model_name = "MobileNet V2 Basic"
