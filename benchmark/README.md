...
| ResNet-50 HF ONNX        | TT-Forge-ONNX   | CNN            | Deep residual network for image classification                          | [`tt-forge-onnx/resnet50_hf_onnx.py`](tt-forge-onnx/resnet50_hf_onnx.py)         | 895.02                  | 800                       |
| SegFormer                | TT-Forge-ONNX   | Transformer, CNN    | Transformer-based model for image segmentation and classification       | [`tt-forge-onnx/segformer.py`](tt-forge-onnx/segformer.py)                   g     | 11.66                 | 40                       |
